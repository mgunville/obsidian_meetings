...
EOF
  ...
  append_if_missing "$env_path" "MEETINGCTL_TRANSCRIPTION_BACKEND" "sidecar"
  append_if_missing "$env_path" "MEETINGCTL_TRANSCRIPTION_FALLBACK_TO_WHISPER" "1"
  append_if_missing "$env_path" "MEETINGCTL_DIARIZATION_KEEP_BASELINE" "1"
  append_if_missing "$env_path" "MEETINGCTL_DIARIZATION_REQUIRE_SPEAKER_LABELS" "1"
